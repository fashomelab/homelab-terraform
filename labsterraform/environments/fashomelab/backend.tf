# labsterraform/environments/fashomelab/backend.tf
...
terraform {
  backend "azurerm" {
    ...
    container_name       = "terradata-proxmox-prod"       # Replace with actual name post-bootstrap
    key                  = "fashomelab.terraform.tfstate" # Environment-specific key
