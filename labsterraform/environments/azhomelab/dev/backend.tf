# /labsterraform/environments/azhomelab/dev/backend.tf
...
terraform {
  backend "azurerm" {
    ...
    container_name       = "terradata-azure-dev"         # Replace with actual name post-bootstrap
    key                  = "azlabpdev.terraform.tfstate" # Environment-specific key
